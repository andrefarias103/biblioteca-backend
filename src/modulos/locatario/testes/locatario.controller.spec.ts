...
describe('LocatarioController', () => {
  ...
  describe(' - Cadastro', () => {
    it('Deve cadastrar um novo locatario com sucesso', async () => {
      ...
      expect(await locatarioController.cadastrar(mockLocatarioDto)).toEqual(
        resultado,
      );
    });
    ...
    it('Deve ocorrer erros durante o cadastro do locatario', async () => {
      ...
      await expect(
        locatarioController.cadastrar(mockLocatarioDto),
  ...
  describe(' - Atualização', () => {
    it('Deve atualizar os dados de um locatario existente', async () => {
      ...
      expect(await locatarioController.atualizar(id, mockLocatarioDto)).toEqual(
        resultado,
      );
    });
    ...
    it('Deve ocorrer erros durante a atualização dos dados do locatario', async () => {
      ...
      await expect(
        locatarioController.atualizar(id, mockLocatarioDto),
      ).rejects.toThrow(error);
    });
  });
